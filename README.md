...
The first stage emulates the totum replacement room where the user must replace the object on the stand. If it is completed before the timer runs out, the beam breaks, and they pass the first round. <br>
...
Lastly, the user is sent on a scavenger hunt to find the real treasure outside. <br><br>
