...
SerialPort USART1_PORT = {
    ...
    0x00,                     // APB1 mask not used
    RCC_AHBENR_GPIOAEN,
    0x00280000,              // ✅ MODER: PA9 + PA10 to Alternate Function (10b)
    0x003C0000,              // ✅ OSPEEDR: Set high speed
    0x77000000,              // ✅ AFR[1]: AF7 for PA9 (AF[1] bits 7:4) and PA10 (bits 11:8)
    0x0,
    NULL,
    NULL
};
